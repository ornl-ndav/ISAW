/*
 * @(#)IDGSpectrometerTofDataSetFactory.java  0.1  2000/06/01  Dennis Mikkelson
 *
 * ---------------------------------------------------------------------------
 *
 *  $Log$
 *  Revision 1.1  2000/07/10 22:22:20  dennis
 *  Basic DataSetFactory for specific instrument
 *
 *  Revision 1.1  2000/06/01 21:17:44  dennis
 *  Initial revision
 *
 *
 */
...
public class IDGSpectrometerTofDataSetFactory extends    DataSetFactory
                                              implements Serializable
{
   ...
   * a Time-of-Flight Indirect Geometry Spectrometer. 
   *
   ...
   *                    direction. 
   */
  public IDGSpectrometerTofDataSetFactory( String  title, 
                                           String  x_units,
                                           String  x_label,
                                           String  y_units,
                                           String  y_label )
   ...
   * list of operators suitable for a Time-of-Flight Indirect Geometry 
   * Spectrometer.
   * 
   * @param   title     String giving a title for the DataSets produced.
   */
   ...
   * from a Time-of-Flight Indirect Geometry Spectrometer.
   */
