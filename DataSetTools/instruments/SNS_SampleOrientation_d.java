/*
 * File:  SNS_SampleOrientation_d.java
 *
...
import DataSetTools.math.tof_calc_d;
...
public class SNS_SampleOrientation_d extends SampleOrientation_d
{
  /**
   *  Construct a SampleOrientation_d object using the phi, chi and omega
   ...
   *              
   */
  public SNS_SampleOrientation_d( double phi, double chi, double omega  )
  {
    super( phi, chi, omega );
  }
