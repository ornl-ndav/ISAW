...
public class close extends GenericOperator{
   ...
   public void setDefaultParameters(){
      ...
      addParameter( new PlaceHolderPG("graphics  devices",null));
   }
   ...
   public String getDocumentation(){
      ...
      S.append("");
      S.append("@param   ");
      S.append("The graphics device which will be closed");
      S.append("@error ");
      S.append("");
      return S.toString();
   }
   ...
   public Object getResult(){
      try{
         ...
         gov.anl.ipns.DisplayDevices.GraphicsDevice.close(gd );
;
         return "Success";
      }catch( Throwable XXX){
