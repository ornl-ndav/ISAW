 ...
 */
public class Tan extends GenericCalculator{
  /**
   * Creates operator with title "Tan of Angle in Radians"
   */  
  public Tan(){
    super( "Tan of Angle in Radians" );
  }

  /** 
   * Creates operator with title "Tan of Angle in Radians" and the
   * specified list of parameters. The getResult method must still be
   * used to execute the operator.
   *
   * @param angle value in radians whose tangent is to be returned
   */
  public Tan( float angle ){
    this(); 
  ...
  /**
   * Returns description/attributes of Tan for a user
  ...
  public String getDocumentation(){
    ...
    // overview
    sb.append("@overview This operator calculates the tangent of the given value.");
    // algorithm
    sb.append("@algorithm Value is passed to java's Math.sin");
    // parameters
    sb.append("@param float value in radians whose tangent is to be returned");
    // return
    sb.append("@return tangent of specified angle");
    // errors
    sb.append("@error ");
   ...
   * 
   * @return  "Tan", the command used to invoke this 
   *           operator in Scripts
   */
   ...
   *
   *  @return If successful, this operator returns the tangent of the specified value.
   */
  public Object getResult(){
    // get the input value
    float value  = ((Float)getParameter(0).getValue()).floatValue();
    //Check to see if the input value is in the required range.
    float angle = (float)Math.tan((double)value);
