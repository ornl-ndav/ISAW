/* 
 * File: Make_d_Histograms_Op.java
 *
...
/**
 *  This class is an Operator wrapper around the Make_d_Histograms method
 *  for use by multiple threads for loading events.
 */
public class Make_d_Histograms_Op implements IOperator
{
  ...
  private double[]          d_map;
  private int[][]           ghost_ids;
  private double[][]        ghost_weights;


  /**
   *  Construct a Make_d_Histograms_Op operator to load the specified
   *  set of events.
   */
  public Make_d_Histograms_Op( SNS_Tof_to_Q_map  mapper,
  ...
  public Object getResult()
  {
    ...
    if ( ghost_ids != null )
      histograms = mapper.Make_d_Histograms( ev_list,
                                             first_event,
                                             num_events,
                                             binner,
                                             d_map,
    ...
    {
      int[][] int_histograms = mapper.Make_d_Histograms( ev_list,
                                                         first_event,
                                                         num_events,
                                                         binner,
                                                         d_map );
