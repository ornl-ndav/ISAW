...
public class GLADQ2R implements Wrappable, IWrappableWithCategoryList
{
  ...
  public String getDocumentation(  ) {
    ...
    s.append( "@overview This class uses Ftr.java to convert I(Q) to S(Q) ");
    s.append( "and preform the Fourier transformation from S(Q) ");
    s.append( "to various distribution functions. It corresponds ");
    s.append( "to the FTR routine on GLAD." );
    return s.toString(  );
  }
