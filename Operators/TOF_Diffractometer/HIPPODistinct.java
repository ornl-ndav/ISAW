...
//  public float Rmin = 0.3f;
  ...
  public String getDocumentation(  ) {
    ...
    s.append( "@overview This class subtracts the self-scattering ");
    s.append( "part from sample differential cross section and ");
    s.append( "converts the vanadium calibration function to ");
    s.append( "a flux function for weighting. ");
