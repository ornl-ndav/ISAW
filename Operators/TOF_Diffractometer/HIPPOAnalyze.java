...
//  public float scattererm = HIPPORunProps.getfloatKey(HIPPORunProps.defHIPPOProps, "HIPPO.ANALYSIS.SCC");
  ...
  public String getDocumentation(  ) {
    ...
    s.append( "@overview  This class performs the multiple scattering ");
    s.append( "and attenuation correction.  It corresponds to ");
    s.append( "ANALYSE/CORAL of the ATLAS package.");
