 ...
 * 
 *  $Log$
 *  Revision 1.13  2006/07/10 22:10:20  dennis
 *  Removed unused imports after refactoring to use new Parameter GUIs
 *  in gov.anl.ipns.Parameters.
 *
 *  Revision 1.12  2006/07/10 16:26:11  dennis
 *  Change to new Parameter GUIs in gov.anl.ipns.Parameters
 *
 *  Revision 1.11  2004/05/10 20:42:30  dennis
 ...
 *  math and utilities.
 *
 *  Revision 1.8  2004/03/15 03:37:01  dennis
   ...
   if ( imchi_ds == null )
    ...
    else
    {
      ...
      if ( imchi_ds instanceof DataSet )
        new ViewManager((DataSet)imchi_ds,IViewManager.IMAGE);
    }
