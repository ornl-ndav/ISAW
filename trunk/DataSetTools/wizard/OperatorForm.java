 ...
 * many of the methods.  The OperatorForms also have the advantage of
 * automated parameter linking, and thus can "return" more than one result.
 */
public class OperatorForm extends Form implements Serializable, HiddenOperator {
   ...
   *  Automatically makes the result of the Operator the last parameter.
   */
