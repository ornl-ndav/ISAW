 ...
 *
 *  $Log$
 *  Revision 1.3  2007/02/25 20:21:48  rmikk
...
public class TetragonalFitError extends SCD_ConstrainedLsqrsError
{

 /* ----------------------------- constructor --------------------------- */
 /**
  *  Construct a new TetragonalFitError model function object for the 
  ...
  */
  public TetragonalFitError( double hkl_vals[][], double q_vals[][] )
  {
    super("TetragonalFitError", new double[2], new String[2], hkl_vals, q_vals);
  }
