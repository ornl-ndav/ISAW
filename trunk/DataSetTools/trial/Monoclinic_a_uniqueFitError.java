...
public class Monoclinic_a_uniqueFitError extends SCD_ConstrainedLsqrsError
{
  ...
  */
  ...
  {
    super("Monoclinic_a_uniqueFitError", new double[4], new String[4], hkl_vals, q_vals);
  }
 ...
 /* -------------------------------- init ------------------------------ */
  ...
  protected void init()
  {
    ...
    parameters[3] = lattice_parameters[3];         //  and of 'beta'
  ...
  */
    public static void main(String[] args)
    {
      ...
      Monoclinic_a_uniqueFitError f = new  Monoclinic_a_uniqueFitError( hkl_vals, q_vals );
