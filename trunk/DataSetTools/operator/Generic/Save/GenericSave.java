 ...
 *  standardized header
 *
 *  Revision 1.1  2002/02/22 20:58:14  pfpeterson
...
abstract public class GenericSave extends    GenericOperator 
                                  implements Serializable
{

   protected GenericSave( String title )
   {
      super( title );
   } 
  ...
  public String[] getCategoryList()
  {
    String partial_list[] = super.getCategoryList();  // get list of ancestor
                                                      ...
                                                      // list.
    return AppendCategory( SAVE, partial_list );
  }
} 
