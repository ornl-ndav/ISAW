/*
 * File:  DS_TOF_IDG_Spectrometer.java 
 *
 ...
 *
 *  $Log$
 *  Revision 1.3  2002/11/27 23:19:54  pfpeterson
 *  standardized header
 *
 *  Revision 1.2  2002/03/05 19:26:40  pfpeterson
 *  Updated @see references in javadocs.
 *
 *  Revision 1.1  2002/02/22 21:04:40  pfpeterson
 *  Operator reorganization.
 *
 *
 */

package DataSetTools.operator.DataSet.TOF_IDG_Spectrometer;
...
abstract public class DS_TOF_IDG_Spectrometer extends    DataSetOperator 
                                 implements Serializable
{
   protected DS_TOF_IDG_Spectrometer( String title )
   {
      super( title );
   } 
  ...
  public String[] getCategoryList()
  {
    String partial_list[] = super.getCategoryList();  // get list of ancestor
                                                      ...
                                                      // list.
    return AppendCategory( "TOF_IDG_Spectrometer", partial_list );
  }
