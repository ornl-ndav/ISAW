 ...
 *
 *  Revision 1.2  2002/03/05 19:26:21  pfpeterson
             ...
             implements Serializable
{
  ...
  */
  ...
  {       
    ...
    // to clone it first.
    SpectrometerTofToEnergyLoss op = new SpectrometerTofToEnergyLoss( ds,
                                                                      min_X,
                                                                      max_X,
                                                                      0    );
    ...
    ConvertHistogramToFunction CHTFop = new 
        ConvertHistogramToFunction( new_ds, true, false );
    CHTFop.getResult();
      
    // ResampleDataSet for the new energy loss DataSet
    ResampleDataSet RDSop = new 
        ResampleDataSet( new_ds, min_X, max_X, num_X, false );
    RDSop.getResult();
...
*/                       
  ...
  public Object clone()
  {
    GeneralizedEnergyDistributionFunction new_op = 
                  new GeneralizedEnergyDistributionFunction( );
