/*
 * File:  DataBlockScalarSubtract.java
 *             
 ...
 * Modified:
 *  $Log$
 *  Revision 1.1  2006/02/02 22:57:09  dennis
...
/**
  *  Subtract a constant value from a specified Data block in a DataSet. 
  */

public class DataBlockScalarSubtract extends    ScalarOp 
                                     implements Serializable
{
  ...
  public DataBlockScalarSubtract( )
  {
    super( "Subtract a Scalar from one Data Block" );
  }
   ...
   *  @param  value       The value to be subtracted from each point in 
   *                      the specified Data block
   *  @param  index       The index of the Data block from which the specified
   *                      value will be subtracted. 
   *  @param  make_new_ds Flag that determines whether a new DataSet is
   *                      constructed, or the value is just subtracted from the 
   *                      specified Data block of the DataSet "in place".
   */

  public DataBlockScalarSubtract( DataSet ds, 
                                  float   value, 
                                  int     index, 
                                  boolean make_new_ds )
  {
  ...
  public String getDocumentation()
  {
    ...
    Res.append("@overview This operator subtracts a constant value from a ");
    ...
    Res.append("@param value - the value to subtract from each point in ");
    Res.append("the specified Data block of the current DataSet.");
    Res.append("@param index - the index of the Data block in the DataSet ");
    Res.append("from which the constant value will be subtracted.  ");
    ...
    Res.append("@error \"ERROR: invalid index in Data block scalar Subtract\"");
  ...
  */
   ...
   * values with the constant value subtracted from one Data block, 
  ...
  /* ------------------------------ clone ------------------------------- */
  /**
   * Get a copy of the current DataBlockScalarSubtract Operator.  The list of 
   * parameters and the reference to the DataSet to which it applies are 
   * also copied.
   */
  public Object clone()
  {
    DataBlockScalarSubtract new_op = new DataBlockScalarSubtract( );
  ...
  public static void main( String[] args )
  {
    ...
    Operator op = new DataBlockScalarSubtract( ds, 100, 0, true );
