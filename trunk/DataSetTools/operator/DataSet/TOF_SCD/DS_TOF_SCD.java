 ...
 *
 *  $Log$
 *  Revision 1.4  2003/06/16 19:05:58  pfpeterson
 *  Removed old code and updated to work with new getCategoryList() code
 *  in base operator class.
 *
 *  Revision 1.3  2002/11/27 23:20:27  pfpeterson
 *  standardized header
 *
 *  Revision 1.2  2002/03/05 19:27:07  pfpeterson
 *  Updated @see references in javadocs.
 *
 *  Revision 1.1  2002/02/22 21:05:22  pfpeterson
 *  Operator reorganization.
 *
 *
 */

package DataSetTools.operator.DataSet.TOF_SCD;
...
abstract public class DS_TOF_SCD extends    DataSetOperator 
                                 implements Serializable
{
   private static String[] categoryList=null;
   protected DS_TOF_SCD( String title )
   {
      super( title );
   } 
