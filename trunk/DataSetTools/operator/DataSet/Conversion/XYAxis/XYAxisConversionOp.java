 ...
 *
 *  $Log$
 *  Revision 1.1  2002/02/22 21:01:14  pfpeterson
 *  Operator reorganization.
 *
 *  Revision 1.3  2001/04/26 19:12:02  dennis
 *  Added copyright and GPL info at the start of the file.
 *
 *  Revision 1.2  2001/03/01 20:53:52  dennis
 *  Fixed naming errors in @see comments.
 *
 *  Revision 1.1  2000/11/10 23:10:33  dennis
...
/**
 * Base class for DataSetOperators that convert the both the X and Y axes to 
 * different units.
 *
 * @see DS_Conversion 
 * @see SpectrometerTofToQE 
 *
 */

abstract public class XYAxisConversionOp extends    DS_Conversion 
                                        implements Serializable
{
   protected XYAxisConversionOp( String title )
   {
      super( title );
   } 
  ...
  public String[] getCategoryList()
  {
    String partial_list[] = super.getCategoryList();  // get list of ancestor
                                                      ...
                                                      // list.
    return AppendCategory( XY_AXIS_CONVERSION, partial_list );
  }
