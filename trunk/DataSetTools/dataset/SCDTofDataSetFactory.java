/*
 * @(#)SCDTofDataSetFactory.java     0.1  2000/05/24  Dennis Mikkelson
 *
 * ---------------------------------------------------------------------------
 *  $Log$
 *  Revision 1.1  2000/07/10 22:22:23  dennis
 *  Basic DataSetFactory for specific instrument
 *
 *  Revision 1.2  2000/06/01 21:18:41  dennis
 *  Added TofToChannel and TrueAngle operators
 *
 *  Revision 1.1  2000/05/24 16:52:52  dennis
 *  Initial revision
 *
 *
 */
...
public class SCDTofDataSetFactory extends    DataSetFactory
                                  implements Serializable
{
   ...
   * a Time-of-Flight single crystal diffractometer. 
   *
   ...
   *                    direction. 
   */
  public SCDTofDataSetFactory( String  title, 
                               String  x_units,
                               String  x_label,
                               String  y_units,
                               String  y_label )
   ...
   * list of operators suitable for a Time-of-Flight single crystal
   * diffractometer.
   * 
   * @param   title     String giving a title for the DataSets produced.
   */
   ...
   * from a Time-of-Flight single crystal diffractometer.
   */
