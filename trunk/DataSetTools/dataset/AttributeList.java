...

{
   ...
   * Gets the number of attributes set for this tabulated data object
   ...
   * attributes for this data object.  If the named attribute is not in the
   ...
   * Removes the attribute at the specified index from the list of attributes 

   * for this tabulated data object.
   ...
   * Removes any attribute with the specified name from the list of attributes
