 ...
 * 
 *  $Log$
 *  Revision 1.1  2003/01/15 20:12:13  dennis
...
/**
 * The concrete class for an attribute whose value is a SegmentInfo object.  
 *
...
public class SegInfoAttribute extends    Attribute
{
  ...
  private SegmentInfo value;

  /**
   * Constructs a SegInfoAttribute object using the specified name and value.
   */
  public SegInfoAttribute( String name, SegmentInfo value )
  {
    super( name );
    this.value = new SegmentInfo( value );
  }


  /**
   * Returns a copy the SegmentInfo object that is the value of this
   * attribute, as a generic object.
   */
  public Object getValue( )
  {
     return new SegmentInfo( value );
  } 
 ...
 */
                                                        ...
                                                        ClassNotFoundException
  {
    ...
    if ( IsawSerialVersion != 1 )
      System.out.println("Warning:SegInfoAttribute IsawSerialVersion != 1");
  }
