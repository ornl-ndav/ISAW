/*
 * @(#)SADTofDataSetFactory.java     0.1  2000/05/24  Dennis Mikkelson
 *
 * ---------------------------------------------------------------------------
 *  $Log$
 *  Revision 1.1  2000/07/10 22:22:22  dennis
...
public class SADTofDataSetFactory extends    DataSetFactory
                                  implements Serializable
{
   ...
   * a Time-of-Flight small angle diffractometer. 
   *
   ...
   *                    direction. 
   */
  public SADTofDataSetFactory( String  title, 
                               String  x_units,
                               String  x_label,
                               String  y_units,
                               String  y_label )
   ...
   * list of operators suitable for a Time-of-Flight small angle 
   * diffractometer.
   * 
   * @param   title     String giving a title for the DataSets produced.
   */
   ...
   * from a Time-of-Flight small angle diffractometer.
   */
