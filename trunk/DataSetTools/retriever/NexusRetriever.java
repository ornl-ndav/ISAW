...
public class NexusRetriever extends Retriever implements hasInformation
{
   ...
   /**
    * Mode argument for FixUpDataSet to reset NXDetector values. This mode can
    * be added to other Modes
    */
   public static final int INexDetector   = 1;

   /**
    * Mode argument for FixUpDataSet to reset NXSample values. This mode can be
    * added to other Modes
    */
   public static final int INexSample     = 2;

   /**
    * Mode argument for FixUpDataSet to reset NXBeam values. This mode can be
    * added to other Modes
    */
   public static final int INexBeam       = 4;

   /**
    * Mode argument for FixUpDataSet to reset NXentry global attributes. This
    * mode can be added to other Modes
    */
   public static final int INexAttrGlobal = 8;

   /**
    * Mode argument for FixUpDataSet to reset NXInstrument values that are not
    * NXdetector values. This mode can be added to other Modes
    */
   public static final int INexInstrument = 16; // Non NXdetector entries

   /**
    * Mode argument for FixUpDataSet to reset NXEntry values that are not
    * NXinstrument, NXbeam, NXsample, or global attribute values This mode can
    * be added to other Modes NOTE: Not implemented yet.
    */
   public static final int INexEntry      = 32; // only SDS entries

   /**
    *@param dataSourceName
    *           should be a local filename
    *           <P>
   ...
   public NexusRetriever(String dataSourceName)
   {
      ...
      if ( node.getErrorMessage( ) != null )
         if ( node.getErrorMessage( ).length( ) > 0 )
         {
            ...
            DataSetTools.util.SharedData.addmsg( "Cannot Read File: "
                  + errormessage );
    ...
    * 
    * @param filename
    *           the name of the file to get the information or null if it goes
    *           to the standard place for the instrument
    * 
   ...
   /**
    * Uses the information stored in SaveSetUpInf() to initialize the
    * information on the data sets stored in this file.
    * 
    * @param filename
    *           the name of the file to with the information or null if it uses
    *           the standard file for the instrument
    * 
    */
   ...
   /**
    *@param data_set_num
    *           the data set that is to be retrieved
    *           
    ...
    *           
    * @return an array of Strings where the first is the data set name, the
    *         second is the data set type( monitor,sample) and the third is the
    *         string description of a range of default GroupID'x for this data
    *         set.
    *         
    * @see #getType(int )
    */
    ...
    * 
    * @param filename
    *           The name of the nexus file with the data sets
    *           
    * @param DsNums
    *           The data set numbers to be loaded or empty to load all
    *           
    * @param GroupIDs
    *           The group IDs to be loaded or Empty for all.
    *           
    * @param useDefaultCache
    *           Use the default cache for this instrument. This file is located
    *           in user.home/ISAW. Its name starts with the first 3 letters of
    *           the instrument name( first 3 characters of the filename). It
    *           ends with \".startup\".
    * 
    * @param CacheFilename
    *           The name of the filename with the cache information
    * 
    * @return The array of data sets from this NeXus file.
    */
   public static DataSet[] LoadNeXusDataSetsFast(
                                String        filename,
    ...
    * 
    * @param dsNum
    *           the number associated with the data set to be retrieved
    *           
    * @param ids
    *           the groupIDs to keep.
    * 
    * @return the given data set or null if there is no data set or ids
    *         specified.
    */
    ...
    * 
    * @param DS
    *           The data set to be fixed
    * 
    * @param dsNum
    *           The data set number in the NeXus file corresponding to this data
    *           set
    * 
    * @param NexusFileName
    *           The name of the Nexus file with the correct information
    * 
    * @param CacheFilename
    *           Name of the fast load Cache for this type of NeXus files or null
    * 
    * @param Mode
    *           Sum of the INex constants corresponding to the Nexus classes to
    *           be redone
    * 
    * @return true if there is an error( check errormessage) or false if there
    *         is no error
    * 
    * @see #INexDetector
    * @see #INexSample
    ...
    * @see #INexInstrument
    */
   public static boolean FixUpDataSet(DataSet DS, 
                                      int     dsNum,
                                      ...
                                      )
   {
      ...
      NexusRetriever retriever = new NexusRetriever( NexusFileName );
      ...
      String Res = retriever.FixUpDataSet( DS , dsNum , Mode );
    ...
    * @see #INexInstrument
    */
    public String FixUpDataSet( DataSet DS, int dsNum, int Mode)
    {
          boolean res = ext.FixUpDataSet( DS , dsNum , Mode );
          if(!res )
             return null;
          return ext.getErrorMessage( );
    }
   /**
