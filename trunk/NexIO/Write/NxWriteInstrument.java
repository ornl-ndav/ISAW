...
public class NxWriteInstrument
 { String errormessage;
   ...
   * @param Instr   The instrument node to which the detector is to be added
   * @param axis1_link<br>
   *        axis2_link      The axis that are linked between NXdata and 
   *                        NXdetectors
   *@param  startIndex, endIndex   The indecis of the Data Blocks to be <br>
   *                      included in this NXdetector(startIndex-> endIndex-1
   ...
   */
   public boolean processDS( NxWriteNode NxInstr , DataSet DS )
       ...
       if( instr_name != null )
        {
         n1 = NxInstr.newChildNode( "name" , "SDS" );
          ...
          n1.setNodeValue( ( instr_name + cc ).getBytes() , 
                             Types.Char , ranks ); 
    ...
    if( DS.getNum_entries() > 0 )
	     ...
	     {   
               NxWriteNode nxSrce = NxInstr.newChildNode( "Source" , 
                                                         "NXsource" );
