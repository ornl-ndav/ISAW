...
/**
 * Class used to write data to an NxLog node in a NeXus file.
 * @author Dominic Kramer
 */
public class NxWriteLog
{
   /**
    * The error message obtained from the method 
   ...
   /**
    * Creates an NxWriteLog object.
    * @param instrType Currently unused.
    */
   ...
   /**
    * Returns a string describing any error that might have occured 
    * when the method {@link #processDS(NxWriteNode, DataSet, int) 
    * processDS(NxWriteNode, DataSet, int)} was invoked.
    * @return An error message or "" if there is no error
    */
   ...
   /**
    * Extracts the information from the DataSet and writes it to the
    * NxLog portion of a Nexus file.
    * 
