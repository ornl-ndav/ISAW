...
//Total counts
   ...
   private void PackInfo(DataSet DS,float distance[],float phi[],float theta[],float solidAngle[],
            float rawAngle[], float Det2Thet[], float Tot_Count[], int Group_ID[], int startIndex,
           int endIndex)
    {NxData_Gen ng = new NxData_Gen ();
    Object XX;
