...
//
...

    {
	 ...
	 {if( StatusLine == null )System.out.println( "Bad line numbers" + E + "," + E.getStartOffset() + "," + E.getEndOffset() ) ; 
	 else StatusLine.setText( "Bad line numbers" + E + "," + E.getStartOffset() + "," + E.getEndOffset() ) ; 
        }
   ...
   private int executeBlock ( Document Doc , int start ,  boolean exec )
     { int line ; 
       ...
       line = start ; 
       //System.out.print( "In exeBlock line =" + line ) ; 
    ...
    public int executeErrorBlock( Document Doc , int start , boolean execute )
      ...
      int line ; 
       ...
       Element  E ,
	        F ;  
       //System.out.println("In exec Error" ) ; 
       if( Doc == null ) return -1 ; 
       E = Doc.getDefaultRootElement() ; 
       if( start < 0 ) return start ; 
       if( start >= E.getElementCount() ) return start ;   
