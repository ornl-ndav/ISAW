...
{
  //OLD Messages
  /*public static final String CHANGE_SLICE = "Change Slice";
  public static final String CHANGE_DATA = "Change Data";
  public static final String CHANGE_COLOR = "Change Color";
  public static final String CHANGE_VRP = "Change VRP";//*/
