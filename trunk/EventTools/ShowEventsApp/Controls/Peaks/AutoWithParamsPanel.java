...
public class AutoWithParamsPanel extends JPanel
{
  ...
  public AutoWithParamsPanel()
  {
   ...
   this.setBorder(new TitledBorder("Find Matrix Using Lattice Parameters"));
  }
   ...
   */
  public void DoIndexing( MessageCenter message_center, float tolerance )
  {
    ...
    Message message = new Message(Commands.INDEX_PEAKS_WITH_PARAMS, cmd, true);
