...
{   public static final String ER__NumberFormat_Error = "Number Format Error";
    ...
    { 
      ...
      // segment.add(new JLabel(parameter.getName(), javax.swing.SwingConstants.CENTER));
      // segment.add(new JLabel( "Select DataType" , javax.swing.SwingConstants.CENTER ) );
      // segment.add( new JLabel("Form Array ", javax.swing.SwingConstants.CENTER ) );
      // segment.add( P );
      // P = new JPanel();
      // P.setLayout(new GridLayout( 3,1));
      // P.add(intText);

       JLabel jb1 = new JLabel(parameter.getName());
       JLabel jb2 = new JLabel("Select DataType");
       JLabel jb3 = new JLabel("Form Array ");
       jb1.setPreferredSize(new Dimension(150,25));
       jb2.setPreferredSize(new Dimension(150,25));
