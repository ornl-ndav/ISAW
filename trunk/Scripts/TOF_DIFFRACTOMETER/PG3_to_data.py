...
class PG3_to_data(GenericLoad):
    ...
    def __init__(self):
        Operator.__init__(self, "PG3_to_data")
        self.instr = "PG3"
        try:
            self.IOBS = IOBS
        except:
    ...
    def setDefaultParameters(self):
        ...
        self.addParameter(IntegerPG("PG3 vanadium run number",1371))
    ...
    def processRun(self, runnumber):
        ...
        if self.VanadiumDS is not None and "fullprof" in save_as:
