...
public class LowPassFilterDS extends GenericSpecial
{
  ...
  *                  
  */
  public LowPassFilterDS( DataSet p_ds, float cutoff, int order )
  {
    this();
  ...
  */
  public Object clone()
  { 
    Operator op = new LowPassFilterDS();
  ...
  */
  public static void main( String args[] )
  {
    ...
    Operator op  = new LowPassFilterDS( ds, 0.1f, 1 );          // altered
