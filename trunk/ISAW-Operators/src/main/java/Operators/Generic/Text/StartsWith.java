 ...
 */
public class StartsWith extends GenericOperator{
   ...
   public void setDefaultParameters(){
      ...
      addParameter( new StringPG("End String","String to look for"));
   }
   ...
   public String getDocumentation(){
      ...
      S.append("@overview    "); 
      S.append("This method checks to see if the input string starts with a specified string.");
      S.append("@algorithm    "); 
      S.append("Uses Java's String.startsWith method");
      S.append("@assumptions    "); 
      S.append("");
      S.append("@param   ");
      S.append("The string to be searched.");
      S.append("@param   ");
      S.append("The String to look for.");
      S.append("@error ");
      S.append("");
      return S.toString();
   }
   ...
   public Object getResult(){
      try{
         ...
         boolean Xres=Operators.Generic.Text.StringMethods.StartsWith(inStr,compStr )
;
