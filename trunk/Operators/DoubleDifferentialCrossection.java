 ...
 * Copyright (C) 2000, 2001 Dennis Mikkelson
 *
      ...
      else
      {
        ...
        for ( int i = 0; i < num_y; i++ )
        {
          ...
          //    fpcorr = result[1];
                ...
                def    = 2*tof_calc.Energy(spherical_coords[0]+fpcorr, tof)*
                         delta_tof/tof;
          //    def    = delta_tof;
  ...
  */
  public static void main( String args[] )
  {
    ...
    else
    {
      ...
      {
        ViewManager vm2 = new ViewManager((DataSet)ddif_ds,IViewManager.IMAGE);
      }
    }
