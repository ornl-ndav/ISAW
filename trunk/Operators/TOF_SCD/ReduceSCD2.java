...
@see Operators.TOF_SCD.AutoReduceSCD#ReduceSCD2(java.lang.String,java.lang.String,int,float,float,java.lang.String,int,float,int,float,float,float,float,float,float,float,java.lang.String,float,boolean,java.lang.String)
 */
public class ReduceSCD2 extends GenericOperator{
   ...
   public String getDocumentation(){
      ...
      S.append(" file, producing a file of integrated intensities.  The resulting file");
      S.append(" will be indexed as a Niggli reduced cell.  Predicted peak positions");
      S.append(" are made based on the Niggli reduced cell.");
       S.append("\r\n");
     S.append(" This operator wraps the method Operators.TOF_SCD.AutoReduceSCD#ReduceSCD2(java.lang.String,java.lang.String,int,float,float,java.lang.String,int,float,int,float,float,float,float,float,float,float,java.lang.String,float,boolean,java.lang.String)");
      S.append("@algorithm    "); 
      S.append("The methods employed in this operator are essentially");
      S.append(" the same methods used by IsawEV.  Peaks are found");
      S.append(" using the same method as in IsawEV. Peaks are indexed");
      S.append(" using the FFT algorithm.  Peaks are integrated using the");
      S.append(" same spherical integration method as in IsawEV.");
      ...
      S.append(" If no file is specified, the default .DetCal file");
      ...
      S.append("@param   ");
      S.append("A lower bound for the length of any real space cell");
      S.append(" edge.");
      S.append("@param   ");
   ...
   public Object getResult(){
      try{
         ...
         float radius = ((FloatPG)(getParameter(17))).getfloatValue();
         boolean integrate_all = ((BooleanPG)(getParameter(18))).getbooleanValue();
         java.lang.String integrate_file = getParameter(19).getValue().toString();
         Operators.TOF_SCD.AutoReduceSCD.ReduceSCD2(instrument,DetCal_file,num_bins,max_Q,wavelength_power,event_file,num_to_find,threshold,run_number,phi,chi,omega,mon_count,min_d,max_d,tolerance,matrix_file,radius,integrate_all,integrate_file );
