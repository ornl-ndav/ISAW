/* 
 * File: wizardSetProjectsDirectory.java
 *  
...
public class wizardSetProjectsDirectory extends GenericOperator{
    ...
    */
   public wizardSetProjectsDirectory(){
     super("wizardSetProjectsDirectory");
     }
   ...
   public String getCommand(){
      return "wizardSetProjectsDirectory";
   }
   ...
   public void setDefaultParameters(){
      ...
      addParameter( new DataDirPG("Project Directory",""));
   }
   ...
   public String getDocumentation(){
      ...
      S.append("");
      S.append("@param   ");
      S.append("The Wizard to be changed.");
      S.append("@param   ");
      S.append("The project directory for this Wizard.");
      S.append("@error ");
      S.append("");
      return S.toString();
   }
   ...
   public Object getResult(){
      try{
         ...
         java.lang.String myDir = getParameter(1).getValue().toString();
         Operators.Generic.Wizard.WizardMethods.wizardSetProjectsDirectory(myWiz,myDir);
         return "Success";
      }catch( Throwable XXX){
