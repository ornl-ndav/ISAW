 ...
 *
 * $Log$
 * Revision 1.2  2006/07/10 16:26:09  dennis
 ...
 */
public class UpperCase extends GenericOperator{
   ...
   public String getDocumentation(){
      ...
      S.append("@overview    "); 
      S.append("This method converts the input string to upper case.");
      S.append("@algorithm    "); 
      S.append("Uses Java's String.toUpper() method.");
   ...
   public Object getResult(){
      try{
         ...
         java.lang.String Xres=Operators.Generic.Text.StringMethods.UpperCase(inStr )
;
         return Xres;
       }catch( Throwable XXX){
