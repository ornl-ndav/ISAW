...
public class RemovePeaks extends GenericOperator{
   ...
   public String getDocumentation(){
      ...
      S.append(" If it is a time-of-flight DataSet, for each");
      S.append(" Data block in the DataSet, the position of each");
      S.append(" peak listed in the peaks file will be converted to");
      ...
      S.append(" the right endpoint, where N is the specified");
      S.append(" Number of Channels to Average.");
      S.append("@assumptions    "); 
      S.append("The DataSet must be a time-of-flight or d-spacing ");
      S.append(" DataSet.");
      S.append(" If the DataSet is a time-of-flight DataSet, it must");
      S.append(" have attributes specifying the initial flight path");
      ...
      S.append(" must be interms of time-of-flight or Angstroms.");
      S.append("@param   ");
      ...
      S.append("@param   ");
      S.append("Estimate of the width of the peaks specified by an");
      S.append(" estimate of delta_d/d.  The actual width used will");
      ...
      S.append(" 1. The DataSet is null or empty.");
      S.append(" 2. The DataSet is not a time-of-flight or d DataSet.");
      S.append(" 3. L1 or Detector Position attributes are missing");
      S.append(" in a time-of-flight DataSet.");
      S.append(" 4. The DataSet is not a histogram.");
      S.append(" 5. The peak file doesn't exist or can't be read.");
      S.append(" 6. Delta_d/d is less than or equal to zero.");
      S.append(" 7. The replace_distance is less than 1 or more than 20.");
      S.append(" 8. The num_to_average is less than 1 or more than 100.");
      return S.toString();
   }
