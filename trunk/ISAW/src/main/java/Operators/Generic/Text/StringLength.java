 ...
 */
public class StringLength extends GenericOperator{
   ...
   public String getDocumentation(){
      ...
      S.append("@overview    "); 
      S.append("Find the length of the input string.");
      S.append("@algorithm    "); 
      S.append("Uses Java's String.length() method.");
   ...
   public Object getResult(){
      try{
         ...
         int Xres=Operators.Generic.Text.StringMethods.StringLength(inStr )
;
