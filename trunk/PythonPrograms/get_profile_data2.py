...
"""
START                # begin list of run numbers and monitor counts
5677     1195208
5678     1194706
5679     1218013
5680     1195027
...
END
Ni                   # experiment name
C:\Users\Arthur\Desktop\profile_fit5_Ni_5677_test\TOPAZ_2012_05_25.DetCal     # calibration file
C:\data\TOPAZ\Ni\    # Directory location of EventsToQ.bin files
0                    # finbary file type: 0 if Binary_Little_Endian(PC), 1 if Binary_Big_Endian(Java)
F                    # P, A, B, C, F, I or R centering
0.2                  # dmin
0.5                  # wlmin
3.4                  # wlmax
...
user_input = open('get_profile_data2.inp', 'r')
user_param = []
run_numbers = []
monitor_counts = []
...
file_type = float(user_param[3])  # 0 if Binary_Little_Endian(PC), 1 if Binary_Big_Endian(Java)
center_type = user_param[4]
