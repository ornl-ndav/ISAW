...
/**
 *  This node calls glEnable with a specified parameter when
 ...
 *
 *    NOTE: glEnableNodes should be used sparingly, since by design they
 *  have side effects and may interfere with the normal functioning of
 *  other nodes in SSG_Tools.
 */

public class glEnableNode extends Node
{
  private int capability;               // the capability to be enabled


/* ------------------------------ constructor --------------------------- */
/**
 *  Construct a node to enable a specified OpenGL capability when the
 *  node is rendered.
 *
 *  @param  capability  The OpenGL capability that will be enabled,
 *                      such as GL.GL_Lighting, GL.GL_CULL_FACE, or
 *                      GL.GL_NORMALIZE 
 */ 
  public glEnableNode( int capability )
  {
...
/* ------------------------------ Render --------------------------- */
/**
 *  Call glEnable to enable the capability specified when this node
 *  was constructed. 
 *
 *  @param  drawable  The drawable for which the glEnable method will
 *                    be called.
 */ 
