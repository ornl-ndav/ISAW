...
/**
 *  This class extends a GLJPanel to include an instance of a jogl GLU
...
public class SSG_JPanel extends GLJPanel implements IGetGLU
{
  private static final long serialVersionUID = 1;

  GLU glu;
 
  public SSG_JPanel( GLCapabilities capabilities )
  {
    super( capabilities );
    glu = new GLU();
  }
  ...
  /**
   *  Get a reference to the GLU object associated with this GLJPanel.
   *
   *  @return a reference to a GLU object that was constructed for use
   *          with this SSG_JPanel object.
   */
  public GLU getGLU()
  {
    return glu;
