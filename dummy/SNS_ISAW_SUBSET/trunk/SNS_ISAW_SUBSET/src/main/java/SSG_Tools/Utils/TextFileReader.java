 ...
 *
 *  Revision 1.2  2005/10/14 17:22:02  dennis
 *  Minor code clean up.  Removed some unnecssary else clauses.
 *
 *  Revision 1.1  2005/10/14 04:07:49  dennis
...
public class TextFileReader 
{
  ...
  public void SkipLinesStartingWith( String skip_string ) throws IOException
  {
    ...
    while (not_done)
      not_done = read_line().startsWith( skip_string );
    unread();
  }
