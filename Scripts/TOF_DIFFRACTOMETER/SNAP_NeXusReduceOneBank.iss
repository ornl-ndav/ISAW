...
# detectors and save the sum to a file in a specified directory.  It will also
# remove any spectra that contain peaks that are found by the find peaks
...
ds = sample_ds_vec[0]
#Display "USING CALIB FILE "&calib_file
Calib(ds,calib_file)
...
if (omit_peaks)
  PeakInfo = getBasicPeakInfo( focused_ds, 100, 0, true )
  OmitSpectraWithPeaks( focused_ds, PeakInfo )
endif
