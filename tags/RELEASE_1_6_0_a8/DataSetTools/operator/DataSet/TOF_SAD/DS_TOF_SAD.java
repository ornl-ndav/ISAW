...
package DataSetTools.operator.DataSet.TOF_SAD;
...
abstract public class DS_TOF_SAD extends    DataSetOperator 
                                 implements Serializable
{
   private static String[] categoryList=null;
   protected DS_TOF_SAD( String title )
   {
      super( title );
   } 
