/*
 * File:  Monoclinic_a_uniqueFitError.java
 *
 ...
 *
 *  Revision 1.1  2006/01/05 23:15:29  rmikk
 *  Initial Checkin
 *
 */
 ...
 * Monoclinic(a_unique).  It is intended to be used for optimizing the 
 * values in the constrained "B" matrix, Bc.
 */

public class Monoclinic_a_uniqueFitError extends SCD_ConstrainedLsqrsError
{

 /* ----------------------------- constructor --------------------------- */
 /**
  *  Construct a new Monoclinic_a_uniqueFitError model function object for the 
  ...
  */
  public Monoclinic_a_uniqueFitError( double hkl_vals[][], double q_vals[][] )
  {
    super( "Monoclinic_a_uniqueFitError", 
            new double[4], 
            new String[4], 
            hkl_vals, 
            q_vals );
 ...
 /* -------------------------------- init ------------------------------ */
   ...
   *  to a Monoclinic_a_unique unit cell.
   */
  protected void init()
  {
    ...
    parameters[3] = lattice_parameters[3];         // and of 'alpha'
  }
 ...
 /* ---------------------------- setParameters --------------------------- */
   ...
   *  "alpha" from params[0..3].  It sets those into the list of all six
   *  lattice parameters, using the Monoclinic ( a unique ) unit cell
   *  constraints.  
  ...
  */
    public static void main(String[] args)
    {
      ...
      Monoclinic_a_uniqueFitError f = 
                        new Monoclinic_a_uniqueFitError( hkl_vals, q_vals );
