 ...
 */
public class TextFileFilter extends RobustFileFilter {
  /**
  ...
  public TextFileFilter() {
    super();
    super.setDescription("Text file (*.txt)");
    super.addExtension(".txt");
    super.addExtension(".java");
    super.addExtension(".f");
    super.addExtension(".c");
  }
}
